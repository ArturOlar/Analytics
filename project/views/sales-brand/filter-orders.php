<form action="/sales-brand" method="POST">
...
<div class="text-center py-3">
    ...
    <form action="/download-sales-brand-excel" method="POST" target="_blank">
        <? foreach ($checkBrands as $key => $value) : ?>
